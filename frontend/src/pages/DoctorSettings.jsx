            ...
            <form onSubmit={handleUpdateAvailability} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col w-full">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300 w-[80px] inline-block mb-1">Start time</label>
                  <input type="time" className="w-full rounded-lg border px-3 py-2.5 text-sm bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-colors duration-150" value={availabilityForm.startTime} onChange={(e) => setAvailabilityForm(p => ({ ...p, startTime: e.target.value }))} required />
                </div>
                <div className="flex flex-col w-full">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300 w-[80px] inline-block mb-1">End time</label>
                  <input type="time" className="w-full rounded-lg border px-3 py-2.5 text-sm bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-colors duration-150" value={availabilityForm.endTime} onChange={(e) => setAvailabilityForm(p => ({ ...p, endTime: e.target.value }))} required />
                </div>
              </div>
              <div className="flex justify-end pt-2">
